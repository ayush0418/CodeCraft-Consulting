...
import './SignUpUStyles.css';
import $ from 'jquery';


function SignUpU(props) {
    ...
    const handleOnSubmit = async (e) => {
        ...
        if (validations(dataObj)) {
            ...
            var response = await fetch('/customerSignUp', {
                method: 'POST',
                mode: 'no-cors',
                cache: 'no-cache',
                ...
                <div className='Signup'>
                    <div id='forms'>
                        ...
                        <div className='d-flex button-container'>
                            <div > <Link to='/UserSignUp'> <button id='User'>User</button> </Link> </div>
                        </div>
                        ...
                        <form className="vip-form" action="" onSubmit={handleOnSubmit}>
                            <div className="vip-form-inner">
                                ...
                                <p id="accountExists"><b>Already have an account?</b><Link to="/UserLogin" id='signInBtn'> <b>Sign in</b></Link></p>
                            </div>
                        </form>
                    </div>
                </div>
